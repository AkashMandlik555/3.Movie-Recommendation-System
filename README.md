...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/AkashMandlik555/Movie-Recommendation-System-with-Sentiment-Analysis/blob/master/requirements.txt) file with the command `pip install -r requirements.txt`
